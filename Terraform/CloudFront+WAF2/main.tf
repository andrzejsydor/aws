resource "aws_wafv2_web_acl" "aws_wafv2_web_acl_CLOUDFRONT" {
  name        = "CLOUDFRONT-managed-rule"
  description = "Example of a CLOUDFRONT managed rule."
  scope       = "CLOUDFRONT"
...
resource "aws_cloudfront_distribution" "cloudfront_distribution" {
    ...
    # AWS WAF WEB ACL
    web_acl_id = aws_wafv2_web_acl.aws_wafv2_web_acl_CLOUDFRONT.arn
